...
public class FrameTiming extends Structure {
	...
	protected List<? > getFieldOrder() {
		return Arrays.asList("DeltaSeconds", "Pad", "ThisFrameSeconds", "TimewarpPointSeconds", "NextFrameSeconds", "ScanoutMidpointSeconds", "EyeScanoutSeconds");
	}
	public FrameTiming(float DeltaSeconds, float Pad, double ThisFrameSeconds, double TimewarpPointSeconds, double NextFrameSeconds, double ScanoutMidpointSeconds, double EyeScanoutSeconds[]) {
		super();
